/// \file GLFunctions.h
/// \brief contains functions that draw basic 3D objects
/// \author origianl author - Jon Macey, implemented by Edina Morris
/// \date 03/04/14 Updated
/// \Revision History:
/// \todo code optimisations
